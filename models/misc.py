...
class ConvNormActivation(torch.nn.Sequential):
    def __init__(
        ...
        conv_layer: Callable[..., torch.nn.Module] = CustomConv2d,
    ) -> None:
...
class SqueezeExcitation(torch.nn.Module):
    ...
    def __init__(
        ...
        self.fc1 = CustomConv2d(input_channels, squeeze_channels, 1)
        self.fc2 = CustomConv2d(squeeze_channels, input_channels, 1)
...
class MLP(torch.nn.Sequential):
    ...
    def __init__(
        ...
        layers.append(torch.nn.Linear(in_dim, hidden_channels[-1], bias=False))
        layers.append(torch.nn.Dropout(dropout, **params))
