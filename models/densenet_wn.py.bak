...
class _DenseLayer(nn.Module):
    def __init__(
        ...
        self.conv1 = CustomConv2d(num_input_features, bn_size * growth_rate, kernel_size=1, stride=1, bias=False)

        self.norm2 = nn.BatchNorm2d(bn_size * growth_rate)
        self.relu2 = nn.ReLU(inplace=True)
        self.conv2 = CustomConv2d(bn_size * growth_rate, growth_rate, kernel_size=3, stride=1, padding=1, bias=False)
...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features: int, num_output_features: int) -> None:
        ...
        self.conv = CustomConv2d(num_input_features, num_output_features, kernel_size=1, stride=1, bias=False)
...
class DenseNet(nn.Module):
    ...
    def __init__(
        ...
        self.features = nn.Sequential(
            OrderedDict(
                [
                    ("conv0", CustomConv2d(3, num_init_features, kernel_size=7, stride=2, padding=3, bias=False)),
                ...
                if isinstance(module, (nn.Conv2d, nn.Linear)):
                    ...
                    if grad_bias is not None:
                        if opt.update_met == 'min_max':
                            ...
                            prob_bias = torch.full((grad_bias_abs.size()), 1.0).to(grad_bias.device)
                        else:
                            raise NotImplementedError(opt.update_met)
...
def densenet121(*, weights: Optional = None, progress: bool = True, **kwargs: Any) -> DenseNet:
...
def densenet161(*, weights: Optional = None, progress: bool = True, **kwargs: Any) -> DenseNet:
...
def densenet169(*, weights: Optional = None, progress: bool = True, **kwargs: Any) -> DenseNet:
...
def densenet201(*, weights: Optional = None, progress: bool = True, **kwargs: Any) -> DenseNet:
